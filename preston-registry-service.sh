...
# then e.g.
#
#   curl 'localhost:8081/arctos/http://arctos.database.museum/guid/UAM:Herb:74954'
# 
...
IFS=/ read -r PATTERN_NAME IDENTIFIER_PATTERN <<<"$(echo $REQUEST_URI | sed -e 's:^/*::' -e 's:/*$::')"
...
echo
[ -z "$FAIL" ] && ./find-datasets-with-link-pattern.sh $PATTERN_NAME $IDENTIFIER_PATTERN
